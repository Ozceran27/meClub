...
const PAYMENT_STATUS_DETAILS = {
  pendiente: {
    ...
    backendValues: ['pendiente_pago', 'pendiente', 'sin_abonar', 'sin_pagar'],
    badge: {
      bg: 'bg-slate-500/20',
  ...
  senado: {
    ...
    iconColor: '#38BDF8',
    backendValue: 'senado',
    backendValues: ['senado', 'senia', 'senia_parcial', 'senia_total', 'seña', 'señado'],
    badge: {
      bg: 'bg-sky-500/20',
  ...
  cancelado: {
    ...
    backendValues: ['cancelado', 'cancelada'],
    badge: {
      bg: 'bg-rose-500/20',
      border: 'border-rose-400/40',
      text: 'text-rose-100',
